<x-layouts.layout>
    <div class="flex justify-center items-center flex-col pt-5">
        ...
        <form method='POST' action="{{ route('profesores.update', $profesore->id) }}"
            ...
            <div class="mb-4">
                <div class="flex justify-between items-center">
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ $profesore->nombre }}">
                </div>
            ...
            <div class="mb-4">
                <div class="flex justify-between items-center">
                    ...
                    <input type="text" name="apellido" id="apellido" value="{{ $profesore->apellido }}">
                </div>
            ...
            <div class="mb-4">
                <div class="flex justify-between items-center">
                    ...
                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento"
                        value="{{ $profesore->fecha_nacimiento }}">
                </div>
            ...
            <div class="mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <input type="text" name="direccion" id="direccion" value="{{ $profesore->direccion }}">
                </div>
