<x-layouts.layout>
    <div class="flex justify-center items-center flex-col pt-5">
        <p class="text-black text-3xl">Editar estudiante</p>
        <form method='POST' action="{{ route('estudiantes.update', $estudiante->id) }}"
            ...
            <div class="mb-4">
                ...
                <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" value="{{$estudiante->fecha_nacimiento}}">
                </div>
            ...
            <div class="flex justify-between">
                ...
                <a class="btn btn-primary w-48" href="{{route('estudiantes.index')}}">Cancelar</a>
            </div>
